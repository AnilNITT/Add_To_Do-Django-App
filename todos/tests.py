...
class TodosAPITestCase(APITestCase):
    ...
    def authenticate(self):
        self.client.post(reverse('register'),{
            'username':'anil','email':'anil@gmail.com','password':'password123'
        })

        response = self.client.post(reverse('login'), {'email':'anil@gmail.com','password':'password123'})
...
class TestTodoDetailAPIView(TodosAPITestCase):
    ...
    def test_retrieves_one_item(self):
        ...
        todo = Todo.objects.get(id=response.datt['id'])
